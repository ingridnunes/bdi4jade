...
import br.pucrio.inf.les.bdi4jade.util.goal.SequentialGoal;
import br.pucrio.inf.les.bdi4jade.util.plan.ParallelGoalPlanBody;
import br.pucrio.inf.les.bdi4jade.util.plan.SequentialGoalPlanBody;
...
public class DefaultCapability extends Capability {
	...
	/**
	 * @see br.pucrio.inf.les.bdi4jade.core.Capability#setup()
	 */
	@Override
