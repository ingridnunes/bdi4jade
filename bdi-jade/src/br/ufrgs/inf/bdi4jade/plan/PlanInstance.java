...
package br.ufrgs.inf.bdi4jade.plan;
...
import br.ufrgs.inf.bdi4jade.exception.PlanInstantiationException;
...
public class PlanInstance implements GoalListener {
	...
	/**
	 * @see br.ufrgs.inf.bdi4jade.event.GoalListener#goalPerformed(br.ufrgs.inf.bdi4jade.event.GoalEvent)
	 */
	@Override
