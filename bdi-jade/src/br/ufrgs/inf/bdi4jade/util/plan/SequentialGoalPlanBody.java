...
package br.ufrgs.inf.bdi4jade.util.plan;
...
import br.ufrgs.inf.bdi4jade.plan.OutputPlanBody;
...
public class SequentialGoalPlanBody extends Behaviour implements PlanBody,
	...
	/**
	 * @see br.ufrgs.inf.bdi4jade.plan.PlanBody#getEndState()
	 */
	@Override
	...
	/**
	 * @see br.ufrgs.inf.bdi4jade.plan.OutputPlanBody#setGoalOutput(br.ufrgs.inf.bdi4jade.goal.Goal)
	 */
	@Override
